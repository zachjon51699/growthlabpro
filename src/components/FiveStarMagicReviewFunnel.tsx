...
import { Menu, X, Star, ArrowRight, ShoppingCart, ChevronDown, Mail, ChevronUp, MapPin, MessageSquare, MousePointerClick, Sparkles } from 'lucide-react';

interface FiveStarMagicReviewFunnelProps {
  onNavigateBack: () => void;
...
const FiveStarMagicReviewFunnel = ({ 
  onNavigateBack, 
  setCurrentPage,
  isMenuOpen,
  setIsMenuOpen,
  ...
  getCartItemCount,
  toggleMenu
}: FiveStarMagicReviewFunnelProps) => {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                ...
                of customers check reviews before hiring a contractor
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>72%</span> <br />
                of prospects rely on Google reviews when choosing service providers
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>2.7x</span> <br />
                more likely to choose a business with strong review profiles
              </p>
            </div>
          </div>
        </div>
      ...
      {/* What is the review funnel Section */}
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight" style={{color: '#0A2540'}}>
              What is the review funnel?
            </h1>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Feature 1: 5-Star Reviews Only */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <MapPin size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>5-Star Reviews Only</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Each customer gets a unique link designed to collect only 5-star reviews. Anyone rating below 4 stars gets redirected to a private feedback form instead, and you receive an instant alert to resolve concerns before they go public.
              </p>
            </div>

            {/* Feature 2: Automatic Follow-Up Reminders */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <MessageSquare size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Automatic Follow-Up Reminders</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Life gets busy—even satisfied customers forget to review. We send 4-5 thoughtful reminder messages over a month, each personalized and spaced a week apart. This gentle persistence converts happy customers into public testimonials without being pushy.
              </p>
            </div>

            {/* Feature 3: Ask For Reviews In One Click */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <MousePointerClick size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Ask For Reviews In One Click</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                No complicated process—just enter a name and phone number, hit submit, and we take over. Our automation does all the heavy lifting, sending review requests and tracking responses while you focus on your business.
              </p>
            </div>

            {/* Feature 4: Contractor Review Injector */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Sparkles size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Contractor Review Injector</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                If you have a list of past customers, we can run our "Contractor Review Injector" campaign to gradually request reviews from your entire list of previous clients.
              </p>
            </div>
          </div>
        </div>
...
export default FiveStarMagicReviewFunnel;
