...
import { Menu, X, Star, ArrowRight, ShoppingCart, ChevronDown, Mail, ChevronUp, Zap, Sparkles, Gift, Calendar } from 'lucide-react';

interface OneClickMarketingCampaignsProps {
  onNavigateBack: () => void;
...
const OneClickMarketingCampaigns = ({ 
  onNavigateBack, 
  setCurrentPage,
  isMenuOpen,
  setIsMenuOpen,
  ...
  getCartItemCount,
  toggleMenu
}: OneClickMarketingCampaignsProps) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>98%</span> <br />
                of text messages get opened within just 3 minutes
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>30%</span> <br />
                of text marketing campaigns generate sales right away
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>62%</span> <br />
                of people actively participate in text message offers and promotions
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Feature 1: Contractor Lead Revival */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Zap size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Contractor Lead Revival</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Share a list of 150+ previous customers or prospects that didn't convert, and we'll launch a targeted campaign to re-engage them and bring them back as paying clients.
              </p>
            </div>

            {/* Feature 2: Contractor 5-Star Review Injector */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Sparkles size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Contractor 5-Star Review Injector</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Hand us a list of 150+ former customers, and we'll deploy a review-focused campaign with incentives like gift cards to motivate them to share their experience and return for more business.
              </p>
            </div>

            {/* Feature 3: Contractor Holiday Promos */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Gift size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Contractor Holiday Promos</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Provide 150+ previous customers or leads, and we'll execute a holiday-themed campaign designed to reignite their interest. Special offers and exclusive deals drive seasonal revenue and customer loyalty.
              </p>
            </div>

            {/* Feature 4: Contractor Customer Nurture */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Calendar size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Contractor Customer Nurture</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Send us 150+ past clients or prospects, and we'll craft a nurturing campaign with personalized messages and exclusive offers. This keeps your brand fresh in their minds and drives repeat purchases.
              </p>
            </div>
          </div>
        </div>
...
export default OneClickMarketingCampaigns;
