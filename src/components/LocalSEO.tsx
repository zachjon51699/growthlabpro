...
import { Menu, X, Star, ArrowRight, ShoppingCart, ChevronDown, ChevronUp, Monitor, Globe, Settings, FileText, Search } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>93%</span> <br />
                of consumers turn to Google when searching for local services
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>97%</span> <br />
                of potential customers research businesses online before contacting them
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>46%</span> <br />
                of search queries are from customers ready to buy locally
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Feature 1: On-Site SEO */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Monitor size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>On-Site SEO</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                We optimize everything on your website to improve search visibility. Our team analyzes your content quality and tracks monthly improvements in search rankings. We monitor keyword performance growth and adapt to Google's latest algorithm updates. Every keyword targets your actual services. Plus, we identify and optimize underperforming pages with potential—turning them into ranking powerhouses that drive traffic.
              </p>
            </div>

            {/* Feature 2: Off-Site SEO */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Globe size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Off-Site SEO</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                We strengthen your online presence beyond your website to boost search rankings. First, we verify and optimize your Google My Business profile for accuracy and active status. We track your backlink portfolio, watching for growth trends and spotting any lost connections that could hurt rankings. <br /><br />
                We fine-tune your location targeting so you're visible to the right customers—whether you serve a neighborhood, city, or broader region. Every backlink gets quality-checked to ensure they're legitimate and helpful. We also audit search engine indexing to catch any potential delisting problems before they impact visibility.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Technical SEO</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                We handle the technical foundation that search engines need to properly index and rank your site. We scan for accidentally hidden pages, audit loading speeds, verify SSL certificates, test mobile compatibility, and fix broken redirects. Security threats get detected and resolved immediately, and all existing optimizations stay protected.<br /><br />
                We keep your sitemap current and resubmit it when needed. Rich snippets via schema markup help search engines understand your content better. Using Google Search Console, we monitor how Google sees your site, catch security warnings, fix crawl problems, and track performance metrics. Full visibility into traffic, rankings, and keyword trends keeps you informed.
              </p>
            </div>

            {/* Feature 4: Google My Business */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Search size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Google My Business</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Your Google Business Profile gets a complete makeover—we verify all information is correct and your listing is fully active. Backlink monitoring shows us which connections are growing and which ones disappeared. Location settings are dialed in precisely, and we audit every link to confirm they're high-value sources.<br /><br />
                We run regular checks to prevent search engine indexing problems and add structured data markup for richer search results. Google Search Console tells us how well your profile displays, and we fix any security or crawling issues immediately. Performance reviews track traffic patterns, ranking positions, and keyword wins so you see real results.
              </p>
            </div>

            {/* Feature 5: Monthly SEO Reporting */}
            <div className="bg-white p-8 rounded-xl shadow-lg md:col-span-2">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <FileText size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Monthly SEO Reporting</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Every month, you get a comprehensive performance report with traffic analytics, keyword movement, new backlinks gained, and overall website health scores. We break down which content performs best, show how you stack up against competitors, and share local search visibility metrics. Any problems get flagged immediately with step-by-step fixes, keeping your SEO momentum strong month after month.
              </p>
            </div>
          </div>
        </div>
