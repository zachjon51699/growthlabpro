...
import { Menu, X, Star, ArrowRight, ShoppingCart, ChevronDown, Mail, ChevronUp, Phone, BarChart3, Shield } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>80%</span> <br />
                more calls to contractors with a business phone lead to jobs.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>71%</span> <br />
                of customers are more likely to refer contractors with a business phone.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <p style={{color: '#6B7280'}}>
                <span className="text-4xl font-bold" style={{color: '#D4AF37'}}>58%</span> <br />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Feature 1: Legal Business Phone Number */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Phone size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Professional Business Phone Number</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Your business gets a dedicated phone number that's separate from personal lines. This professional approach builds credibility and shows customers you mean business. Every incoming call triggers instant notifications, so you never miss an opportunity to connect.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Call Tracking</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Track every call with detailed analytics showing where your customers found you and which marketing channels drive the most conversations. This data helps you double down on what's working, refine your outreach approach, and stay on top of every potential lead.
              </p>
            </div>

            {/* Feature 3: Separate Personal and Business */}
            <div className="bg-white p-8 rounded-xl shadow-lg md:col-span-2">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 mr-4 flex items-center justify-center" style={{color: '#D4AF37'}}>
                  <Shield size={48} />
                </div>
                <h3 className="text-xl font-bold" style={{color: '#0A2540'}}>Separate Personal and Business</h3>
              </div>
              <p className="text-lg leading-relaxed" style={{color: '#6B7280'}}>
                Keep work and personal life completely separate with dedicated business lines. This organization prevents mix-ups, protects your privacy, and ensures business calls get priority attention. Your customers see a professional operation, and you maintain healthy work-life boundaries.
              </p>
            </div>
          </div>
        </div>
